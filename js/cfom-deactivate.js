...
jQuery(function($){
    ...
    var modal = $('#cfom-deactivate-modal');
    var deactivateLink = '';


    $('#the-list').on('click', 'a.cfom-deactivate-link', function (e) {
        e.preventDefault();
    ...
    $('#cfom-deactivate-modal').on('click', 'a.review-and-deactivate', function (e) {
        e.preventDefault();
    ...
    modal.on('click', 'button.pipe-model-submit', function (e) {
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                action: 'cfom_submit_uninstall_reason',
